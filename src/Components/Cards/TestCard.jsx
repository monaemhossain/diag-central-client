        ...
        <div>
            ...
            <article className="shadow-lg border rounded-md duration-300 hover:shadow-sm text-start min-h-[469px]">
                <div onClick={() => handleDetails(_id)} className='flex flex-col justify-between'>
                    <div>
                        <div className="lg:max-h-60 md:max-h-72">
                            <img src={validator.isURL(image) ? image : "https://t3.ftcdn.net/jpg/02/48/42/64/360_F_248426448_NVKLywWqArG2ADUxDq6QprtIzsF82dMF.jpg"} loading="lazy" alt={title} className="w-full  h-full rounded-t-md" />
                    ...
                    <div className="ml-4 mr-2 mb-3 text-start space-y-3">
